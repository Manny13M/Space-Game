...
#Import/ load images for spaceships
...
#Velocity/ change of move per key
VEL = 5
...
#Method that controls the display of the window
...
#Method that controls yellows movements
...
#Method that controls red movements
...
def main():
    ...
    while run:
        ...
        #Ensure that the while loop runs 60 times per second
        clock.tick(FPS)
...
#Make sure this game only runs if this file is used
